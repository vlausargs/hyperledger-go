...
docker exec -e CORE_PEER_TLS_ENABLED=true -e CORE_PEER_LOCALMSPID="Org1MSP" -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp -e CORE_PEER_ADDRESS=peer0.org1.example.com:7051 cli peer chaincode query -C mychannel -n basic -c '{"Args":["GetAllAssets"]}' | jq '.[0:2]' 2>/dev/null || echo "Sample data initialized with $(docker exec -e CORE_PEER_TLS_ENABLED=true -e CORE_PEER_LOCALMSPID="Org1MSP" -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp -e CORE_PEER_ADDRESS=peer0.org1.example.com:7051 cli peer chaincode query -C mychannel -n basic -c '{"Args":["GetAllAssets"]}' | jq '. | length') assets"
echo ""
...
echo "  Query all assets: cd fabric-samples/test-network && docker exec -e CORE_PEER_TLS_ENABLED=true -e CORE_PEER_LOCALMSPID='Org1MSP' -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp -e CORE_PEER_ADDRESS=peer0.org1.example.com:7051 cli peer chaincode query -C mychannel -n basic -c '{\"Args\":[\"GetAllAssets\"]}'"
echo ""
echo "✅ All systems ready! 🚀"
echo ""
echo "📝 Notes:"
echo "  - Network is running with fabcar chaincode deployed"
echo "  - Chaincode initialized with 10 sample cars"
...
echo "  Query specific car: docker exec -e CORE_PEER_TLS_ENABLED=true -e CORE_PEER_LOCALMSPID='Org1MSP' -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp -e CORE_PEER_ADDRESS=peer0.org1.example.com:7051 cli peer chaincode query -C mychannel -n basic -c '{\"Args\":[\"QueryCar\",\"CAR0\"]}'"
